...
def test_spatial_coordinate_system():
    ...
    assert cs.dim_axes == (axis.vertical, axis.grid_latitude, axis.grid_longitude)
...
def test_coordinate_system():
    ...
    assert cs.dim_axes == (axis.custom('ensemble'), axis.time, axis.vertical, axis.grid_latitude, axis.grid_longitude)
    assert cs.aux_axes == (axis.latitude, axis.longitude)
